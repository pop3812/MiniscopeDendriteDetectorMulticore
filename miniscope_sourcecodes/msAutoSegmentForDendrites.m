function vidObj = msAutoSegmentForDendrites(vidObj, frameLimits, cellAreaLimits, downSamp,corrCoefThreshDefault,plotting)
...
count = 0;
brightSpots = vidObj.brightSpotsContig;
brightSpots = filter2(ones(2,2),brightSpots);
