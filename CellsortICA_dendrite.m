function [ica_sig, ica_filters, ica_A, numiter] = CellsortICA_dendrite(mixedsig, ...
...
%
% Routine is based on the fastICA package (Hugo G?ert, Jarmo Hurri, Jaakko S?el? and Aapo
% Hyv?inen, http://www.cis.hut.fi/projects/ica/fastica)
%
